...
printf "%b\n" "** Clonning my dotfiles directory to $source_dirs"
if git clone https://github.com/harshv5094/dotfiles "$source_dirs"; then
  printf "%b\n" "Success: clonned to $source_dirs"
  # Hyprland Banner #
  cat <<'EOF'
 _                      _                 _ 
| |                    | |               | |
...
EOF
  ...
  printf "%b\n" "Failed: clonning to $source_dirs"
fi
